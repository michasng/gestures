...
final theme =
    ThemeData.from(
      ...
      iconTheme: const IconThemeData(color: _onLightColor),
      ...
      appBarTheme: const AppBarTheme(
        ...
        titleTextStyle: TextStyle(color: _onDarkColor),
      ),
      extensions: [
        const LinkThemeData(color: Color(0xff0086BB), underlined: true),
        const SpinnerThemeData(size: 256),
      ],
    );
